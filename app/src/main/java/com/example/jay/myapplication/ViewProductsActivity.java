                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            if (success == 1){
                                JSONArray products = response.getJSONArray("lab");
                                for(int i =0; i<products.length(); i++){
                                    JSONObject phone = products.getJSONObject(i);
                                    String name = phone.get("name").toString();
                                    String lastname = phone.get("lastname").toString();
                                    String university = phone.get("university").toString();
                                    String gen = phone.get("gen").toString();
                                    jsonResponse = "";
                                    jsonResponse += "Name: " + name + "\n\n";
                                    jsonResponse += "LastName: " + lastname + "\n\n";
                                    jsonResponse += "University: " + university + "\n\n";
                                    jsonResponse += "Gen: " + gen + "\n\n";
